...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public List<User> getGoalRanking() {
        return userMapper.getGoalRanking();
    }

    @Override
    public List<User> getAssistRanking() {
        return userMapper.getAssistRanking();
    }

    @Override
    public List<User> getCutRanking() {
        return userMapper.getCutRanking();
    }

    @Override
    public List<User> getOverallRanking() {
        return userMapper.getOverallRanking();
    }

    @Override
    public User getUserByCode(String u_code) {
        return userMapper.getUserByCode(u_code);
    }

    @Override
    public List<User> getTeamMembers(int t_code) {
        return userMapper.getTeamMembers(t_code);
    }
    ...
    public boolean certificationupdate(String u_pw, User user, Authentication authentication){
        return passwordEncoder.matches(u_pw, user.getU_pw());
    }
